describe("LinkedList", function () {
  ...
  describe("iteration", function () {
    ...
    it("offset", function () {
      this.list.append(this.a, this.b, this.c);
      expect(this.list.offsetOf(this.a)).toBe(0);
      expect(this.list.offsetOf(this.b)).toBe(3);
      expect(this.list.offsetOf(this.c)).toBe(6);
      expect(this.list.offsetOf({})).toBe(-1);
    });
    ...
    it("forEachAt at part of single node", function () {
      this.list.append(this.a, this.b, this.c);
      this.list.forEachAt(4, 2, this.spy.callback);
      expect(this.spy.callback.calls.count()).toBe(1);
      expect(this.spy.callback.calls.first().args).toEqual([this.b, 1, 2]);
    });
  });
});
