...
import { makeAttachedBlot } from "./parent.js";

class ContainerBlot /* extends ParentBlot extends ShadowBlot */ {
  ...
  replaceWith(name, value) {
    ...
    if (replacement instanceof ContainerBlot) {
  ...
  attachUI(node) {
    ...
    if (ContainerBlot.uiClass) {
      this.uiNode.classList.add(ContainerBlot.uiClass);
    }
