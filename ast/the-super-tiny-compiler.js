/**
 * Today we're going to write a compiler together. But not just any compiler...
 * A super duper teeny tiny compiler! A compiler that is so small that if you
 ...
 *        - Moving to the second element of CallExpression's params
 ...
 *       -> NumberLiteral 2 (enter)
 *       <- NumberLiteral 2 (exit)
 *       -> CallExpression substract (enter)
 *          -> NumberLiteral 4 (enter)
 *          <- NumberLiteral 4 (exit)
 *          -> NumberLiteral 2 (enter)
 *          <- NumberLiteral 2 (exit)
 *       <- CallExpression substract (exit)
...
const tokenizedResult = tokenizer("(add 2 (substract 4 2))");
...
const parsedResult = parser(tokenizedResult);
console.log(JSON.stringify(parsedResult, "", 2));
// {
//   type: "Program",
//   body: [
//     {
...
const transformedResult = transformer(parsedResult);
console.log(JSON.stringify(transformedResult, "", 2));
// {
//   type: "Program",
//   body: [
//     {
